...
import DeleteProgressModal from './DeleteProgress';

const DeleteModal = ({ onClose, onProgressComplete }) => {
      ...
      {showProgress && (
        <DeleteProgressModal 
          onClose={() => {
            ...
            onClose(); // Ensure to close the DeleteModal as well
          }} 
          onProgressComplete={onProgressComplete} // Pass the onProgressComplete function
        />
      )}
    </>
  );
