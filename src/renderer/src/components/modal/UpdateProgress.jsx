...
const UpdateProgress
 = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="relative w-[801px] h-[305px] border-2 border-y-[#0C9A8D] border-x-[#05564F] bg-gradient-to-b from-[#091817] to-[#0C1612] flex flex-col items-center justify-center p-8"
      >
        ...
        {/* Checking Text */}
        <p className="text-[#00FFE7] text-3xl  mt-10">Updating</p>
      </div>
    </div>
  );
};
