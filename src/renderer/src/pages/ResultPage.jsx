        ...
        <div className="w-full h-[450px] p-4 border-2 border-y-[#0C9A8D] border-x-[#05564F] bg-gradient-to-b from-[#091817] to-[#0C1612] text-white relative mt-4">
          {loading ? (
            ...
            <div className="space-y-1">
              {[...Array(5)].map((_, index) => (
                <div key={index} className="grid grid-cols-2 border-b border-[#EAECF0] p-2 text-white">
                  <Skeleton width={100} />
                  <Skeleton width={150} />
                </div>
              ))}
            ...
            <div className="relative flex justify-center items-center h-full">
              ...
              <p className="absolute text-center text-[#00FFE7] font-bold text-2xl">No Malware Detected</p>
            </div>
          )}
